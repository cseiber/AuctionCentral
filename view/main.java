...
//		case "Staff":	StaffUI.welcomeScreen((Staff) curUser, myCalendar); break;
		case "NPO": NPOUI.welcomeScreen((NPO) curUser, myCalendar); break;
		case "Bidder": BidderUI.welcomeScreen((Bidder) curUser, myCalendar); break;
		 ...
		 try
	      {
	         ...
	         new FileOutputStream("Calendar.ser");
